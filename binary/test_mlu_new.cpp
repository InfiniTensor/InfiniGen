...
int main(void)
{
  ...
  CNRT_CHECK(cnrtMemcpy(mlu_src3, host_src3, LEN * sizeof(float), cnrtMemcpyHostToDev));
  CNRT_CHECK(cnrtMemcpy(mlu_src4, host_src4, LEN * sizeof(float), cnrtMemcpyHostToDev));
