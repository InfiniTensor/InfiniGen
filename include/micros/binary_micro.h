  ...
  class MICRO_NAME##Micro : public Micro {                                        \
   ...
   public:                                                                        \
    MICRO_NAME##Micro(std::string output_name_string, int64_t output_offset,      \
        ...
        : output_name(output_name_string), output(output_offset),                 \
          left_name(left_name_string), left(left_offset),                         \
          right_name(right_name_string), right(right_offset),                     \
          length(length_value) {}                                                 \
    std::string generatorCode(Cache& cache) override;                             \
  };
